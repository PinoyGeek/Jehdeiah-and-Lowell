              ...
              <div className="flex flex-col w-full">
                ...
                <div className="grid grid-cols-2 gap-1.5 sm:gap-3 md:gap-4">
                  ...
                  <motion.div
                    ...
                    transition={{ duration: 0.25 }}
                  >
                    <Image src="/mobile-background/couple (2).jpg" alt="Wedding moment 2" fill className="object-cover" style={{ imageOrientation: "from-image" }} />
                  </motion.div>
                  <motion.div
                    ...
                    transition={{ duration: 0.25 }}
                  >
                    <Image src="/desktop-background/couple.jpg" alt="Wedding moment 3" fill className="object-cover" />
                  </motion.div>
                </div>
                <p
