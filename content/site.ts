export const siteConfig = {
  ...
  wedding: {
    ...
    motif: "#051C46, #3A5A8C, #E3ECF7, #F8F9FF",
  },
  details: {
    rsvp: {
      deadline: "October15, 2026.",
      contact: "Jehdeiah Diaz Villacote",
      phone: "0923 456 7890",
    },
  },
  ceremony: {
    location: "The Kitchen2K",
    venue: "#13 Real street, Barangay 75, Fatima, Tacloban City, Philippines, 6500",
  ...
  reception: {
    ...
    venue: "Paraiso, Brgy 83. San Jose, Tacloban City, Philippines, 6500",
    facebook: "https://www.facebook.com/paviliontacloban",
    date: "November 29, 2026",
    time: "6:00 PM",
  },
  dressCode: {
